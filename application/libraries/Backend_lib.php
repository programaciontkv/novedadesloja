...
class Backend_lib {
	...
	public function control($opc_id=''){
		...
		if($url=='factura' || $url=='nota_credito' || $url=='guia_remision' || $url=='ingreso' || $url=='egreso'|| $url=='pedido_factura'|| $url=='pedido' || $url=='factura_masivo' || $url=='transferencia' || $url=='kardex'|| $url=='cierre_caja'){
