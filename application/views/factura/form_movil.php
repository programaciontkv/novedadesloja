                ...
                <form id="frm_save" role="form" action="<?php echo $action ?>" method="post" autocomplete="off"
                        ...
                        <tr>
                            <td class="col-sm-2">
                                ...
                                <div class="panel panel-success  " style="width:50%">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <input style="width:105px" type="button" class="btn btn-primary"
                                                onclick="verificar_cedula('9999999999999')" name=""
                                                value="Consumidor final ">

                                        </div>

                                        <div class="col-sm-4">
                                            <input style="width:105px" type="button" class="btn btn-success"
                                                onclick="datos()" name="" value="Con Datos">
                                        </div>

                                        <div class="col-sm-4">
                                            <input style="width:105px" type="button" class="btn btn-info"
                                                onclick="pas()" name="" value="Extranjero">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group <?php if (form_error('identificacion') != '') {
                      echo 'has-error';
                    } ?> ">
                                                    <input type="text" class="form-control" name="identificacion"
                                                        id="identificacion" value="<?php if (validation_errors() != '') {
                        echo set_value('identificacion');
                      } else {
                        echo $factura->fac_identificacion;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group <?php if (form_error('nombre') != '') {
                    echo 'has-error';
                  } ?> ">
                      ...
                      echo $factura->cli_id;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group <?php if (form_error('direccion_cliente') != '') {
                    echo 'has-error';
                  } ?> ">
                                                    <input type="text" class="form-control" name="direccion_cliente"
                                                        id="direccion_cliente" value="<?php if (validation_errors() != '') {
                      echo set_value('direccion_cliente');
                    } else {
                      echo $factura->fac_direccion;
                    } ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group <?php if (form_error('telefono_cliente') != '') {
                      echo 'has-error';
                    } ?> ">
                                                    <input type="text" class="form-control" name="telefono_cliente"
                                                        id="telefono_cliente" value="<?php if (validation_errors('telefono_cliente') != '') {
                        echo set_value('telefono_cliente');
                      } else {
                        echo $factura->fac_telefono;
                      } ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group <?php if (form_error('email_cliente') != '') {
                      echo 'has-error';
                    } ?> ">
                                                    <input type="email" class="form-control" name="email_cliente"
                                                        id="email_cliente" value="<?php if (validation_errors() != '') {
                        echo set_value('email_cliente');
                      } else {
                        echo $factura->fac_email;
                      } ?>">
                  ...
                  <td >
                    <div class="form-group <?php if (form_error('cli_parroquia') != '') {
                      ...
                      <input type="text" class="form-control" name="cli_parroquia" id="cli_parroquia" value="<?php if (validation_errors() != '') {
                        echo set_value('cli_parroquia');
                      } else {
                        echo $factura->cli_parroquia;
                      } ?>">
                      <?php echo form_error("cli_parroquia", "<span class='help-block'>", "</span>"); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group <?php if (form_error('cli_ciudad') != '') {
                      echo 'has-error';
                    } ?> ">
                                                    <input type="text" class="form-control" name="cli_ciudad"
                                                        id="cli_ciudad" value="<?php if (validation_errors() != '') {
                        echo set_value('cli_ciudad');
                      } else {
                        echo $factura->cli_canton;
                      } ?>">
                      ...
                      echo 'has-error';
                                                    ...
                                                    <input type="text" class="form-control" name="cli_pais"
                                                        id="cli_pais" value="<?php if (validation_errors() != '') {
                        echo set_value('cli_pais');
                      } else {
                        echo $factura->cli_pais;
                      } ?>">
              ...
              ?>
                    ...
                    ?>
                                                <tr>
                                                    ...
                                                    <td hidden>
                                                        <input style="text-align:left " type="text" size="7"
                                                    ...
                                                    <td hidden>
                                                        <input type="text" size="7" id="unidad" name="unidad" value=""
                                                            lang="1" readonly class="form-control" />
                                                    </td>
                                                    <td hidden <?php echo $hid_inv ?>>
                                                        <input type="text" size="7" style="text-align:right"
                                                            id="inventario" name="inventario" value="" lang="1" readonly
                                                            class="form-control decimal" />
                                                    </td>
                                                    <td>
                                                        <input type="text" size="7" style="text-align:right"
                                                            id="cantidad" name="cantidad" value="0" lang="1"
                                                    ...
                                                    <td width="70px">
                                                        <input type="text" size="7" style="text-align:right"
                                                            ...
                                                            class="form-control decimal" <?php echo $r_descuento ?> />
                                                    </td>
                                                    ...
                                                    <td width="70px">
                                                        <input type="text" id="iva" style="text-align:right" name="iva"
                                                            size="5" value="" readonly class="form-control decimal" />
                                                    </td>
                                                    <td hidden><input type="text" name="ice_p" id="ice_p" size="5"
                                                            value="0" readonly lang="1" /></td>
                                                    <td hidden><input type="text" name="ice" id="ice" size="5" value="0"
                                                            readonly lang="1" />
                                                        <input type="" name="ice_cod" id="ice_cod" size="5" value="0"
                                                            readonly lang="1" />
                                                    </td>
                                                    <td width="100px">
                                                    ...
                                                    <td align="center"><input type="button" name="add1" id="add1"
                                                            ...
                                                            onclick="validar('#tbl_detalle','0')" lang="1" value='+' />
                                                    </td>
                      ...
                      if (!empty($cns_det)) {
                        ...
                        foreach ($cns_det as $rst_det) {
                          ...
                          ?>
                                                <tr>
                                                    <td hidden id="item<?PHP echo $n ?>" name="item<?PHP echo $n ?>"
                                                        lang="<?PHP echo $n ?>" align="center">
                                                        <?PHP echo $n ?>
                                                    </td>
                                                    <td id="pro_descripcion<?PHP echo $n ?>"
                                                        name="pro_descripcion<?PHP echo $n ?>" lang="<?PHP echo $n ?>">
                                                        <?php echo $rst_det->pro_codigo ?></td>
                                                    <td style="width:20px" id="pro_referencia<?PHP echo $n ?>"
                                                        name="pro_referencia<?PHP echo $n ?>" lang="<?PHP echo $n ?>">
                                                    ...
                                                    <td hidden><input type="text" id="<?php echo 'ice' . $n ?>"
                                                        ...
                                                        <input type="hidden" id="<?php echo 'ice_cod' . $n ?>"
                                                            ...
                                                            class="form-control" value="<?php echo $rst_det->ice_cod ?>"
                                                            lang="<?PHP echo $n ?>" readonly />
                                                    </td>
                                                    <td>
                                                        <input type="text" size="9" style="text-align:right"
                                                            class="form-control" id="<?php echo 'valor_total' . $n ?>"
                      ...
                      ?>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="3"><label>Observaciones (250 Caracteres max.):</label>
                                                    </td>
                                                </tr>
                                                <tr>

                                                    <td valign="top" rowspan="9" colspan="<?php echo $col_obs ?>">
                                                        <textarea style="height: 80px; width: 70%;" id="observacion"
                        ...
                        $total0 = floatval($factura->fac_subtotal0) + floatval($factura->fac_subtotal_ex_iva) + floatval($factura->fac_subtotal_no_iva)
                          ?>
                                                ...
                                                <tr hidden>
                                                    ...
                                                    <td colspan="1"><input style="text-align:right" type="text"
                        ...
                        <td><input style="text-align:right" type="text" class="form-control" id="total_ice" name="total_ice" value="<?php echo str_replace(',', '', number_format($factura->fac_total_ice, $dec)) ?>"  readonly/>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="1"><input type="text" class="form-control"
                                                            id="total_propina" name="total_propina"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="1"><input
                                                            style="text-align:right;font-size:15px;color:red  "
                    ...
                    ?>
                          ...
                          <option value='0'>SELECCIONE</option>
                                                ...
                                                <td><input type="text" id="pag_cantidad1" name="pag_cantidad1"
                                                        class="form-control" size="10px" lang="1"
                                                        onchange="calculo_pagos(this)" onkeyup='validar_decimal(this)'>
                                                </td>
                                                <?php
                      if ($m_pag == 0) {
                        ?>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type="hidden" id="pag_forma<?php echo $m ?>"
                                                        name="pag_forma<?php echo $m ?>" class="form-control"
                                                        size="10px" lang="1" value="<?php echo $rst_pag->pag_forma ?>">
                                                    <input type="hidden" id="pag_tipo<?php echo $m ?>"
                                                        name="pag_tipo<?php echo $m ?>" class="form-control" size="10px"
                                                        lang="<?php echo $m ?>"
                                                        value="<?php echo $rst_pag->pag_tipo ?>">
                                                </td>
                                                <td><input type="text" id="pag_documento<?php echo $m ?>"
                                                    ...
                                                    <input type="hidden" id="val_nt_cre<?php echo $m ?>"
                                                        name="val_nt_cre<?php echo $m ?>" class="form-control"
                                                        size="10px" lang="<?php echo $m ?>">
                                                </td>
                                                <td>
                                                ...
                                                <td><input type="text" id="pag_cantidad<?php echo $m ?>"
                                                        name="pag_cantidad<?php echo $m ?>" class="form-control"
                                                        size="10px" lang="<?php echo $m ?>"
                                                        onchange="calculo_pagos(this)" <?php echo $read_cnt ?>
                                                        value="<?php echo str_replace(',', '', number_format($rst_pag->pag_cant, $dec)) ?>">
                                                </td>
                                                <?php
                        if ($m_pag == 0) {
                          ?>
                                                <td align="center"><span name="add<?php echo $m ?>"
                                                        id="add<?php echo $m ?>" class="btn btn-primary fa fa-plus"
                                                        onclick="validar('#tbl_pagos','1')" lang="<?php echo $m ?>">
                                                    </span></td>
                                                <td onclick="elimina_fila(this, '#tbl_pagos','1')" align="center"><span
                                                        class="btn btn-danger fa fa-trash"></span></td>
                                            </tr>
                  ...
                  ?>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><input type="text" id="faltante" name="faltante"
                                                        class="form-control" size="10px" readonly
  ...
  console.log(pro_descripcion.value);
    ...
    if (d == 0) {
        ...
        var fila = "<tr>" +
            ...
            "<td style='width:25px'>" +
            "<input type ='text' class='form-control decimal' size='10' style='text-align:right' id='cantidad" + i +
            "' name='cantidad" + i + "' lang='" + i + "' onchange='validar_inventario_det()'  value='" + cantidad
            .value + "' onkeyup='validar_decimal(this)'/>" +
            "</td>" +
            "<td style='width:50px'>" +
            "<input type ='text' size='10' style='text-align:right' id='pro_precio" + i + "' name='pro_precio" + i +
            "' onchange='calculo()' value='" + pro_precio.value + "' lang='" + i +
            "' class='form-control decimal' onkeyup='validar_decimal(this)' " + r_precio + " />" +
            "</td>" +
            "<td style='width:50px'>" +
            "<input type ='text' size='10'  style='text-align:right' id='descuento" + i + "' name='descuento" + i +
            ...
            while (n < j) {
                ...
                if (inven == 0 && ($('#pro_ids').val() == '26' || $('#pro_ids').val() == '69')) {
                    if (parseFloat($('#inventario').val()) < parseFloat(cant)) {
                        ///alert('NO SE PUEDE REGISTRAR LA CANTIDAD\n ES MAYOR QUE EL INVENTARIO');
                        swal("Error!",
                            "NO SE PUEDE REGISTRAR LA CANTIDAD. ES MAYOR QUE EL INVENTARIO.! Cantidad disponible " +
                            cant, "error");
