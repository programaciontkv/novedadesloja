            ...
            <div class="box box-primary">
                <form id="frm_save" role="form" action="<?php echo $action ?>" method="post" autocomplete="off"
                    ...
                    <div class="box-body">
                      ...
                      echo 'has-error';
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="identificacion" id="identificacion" value="<?php if (validation_errors() != '') {
                    ...
                    echo 'has-error';
                                                            ...
                                                            <input maxlength="75" type="text" class="form-control"
                                                                name="nombre" id="nombre" value="<?php if (validation_errors() != '') {
                      ...
                      echo $factura->fac_nombre;
                                                        ...
                                                        <input type="hidden" class="form-control" name="cli_id"
                                                            id="cli_id" value="<?php if (validation_errors() != '') {
                    ...
                    echo 'has-error';
                                                            ...
                                                            <input maxlength="75" type="text" class="form-control"
                                                                name="direccion_cliente" id="direccion_cliente" value="<?php if (validation_errors() != '') {
                      ...
                      echo 'has-error';
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="telefono_cliente" id="telefono_cliente" value="<?php if (validation_errors('telefono_cliente') != '') {
                      ...
                      echo 'has-error';
                                                            ...
                                                            <input type="email" class="form-control"
                                                                name="email_cliente" id="email_cliente" value="<?php if (validation_errors() != '') {
                        ...
                        $total0 = floatval($factura->fac_subtotal0) + floatval($factura->fac_subtotal_ex_iva) + floatval($factura->fac_subtotal_no_iva)
                          ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input style="text-align:right" type="text" class="form-control"
                                                            id="total_descuento" name="total_descuento"
