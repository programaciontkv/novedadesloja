              ...
              <tr>
                  ...
                  <td >
                    <div class="form-group <?php if (form_error('identificacion') != '') {
                      ...
                      <input type="text" class="form-control" name="identificacion" id="identificacion" value="<?php if (validation_errors() != '') {
              ...
              <tr>
                ...
                <td >
                  <div class="form-group <?php if (form_error('nombre') != '') {
                    ...
                    <input maxlength="75" type="text" class="form-control" name="nombre" id="nombre" value="<?php if (validation_errors() != '') {
                    ...
                    <input type="hidden" class="form-control" name="cli_id" id="cli_id" value="<?php if (validation_errors() != '') {
              ...
              <tr>
                ...
                <td >
                  <div class="form-group <?php if (form_error('direccion_cliente') != '') {
                    ...
                    <input maxlength="75" type="text" class="form-control" name="direccion_cliente" id="direccion_cliente" value="<?php if (validation_errors() != '') {
                ...
                <tr>
                  ...
                  <td >
                    <div class="form-group <?php if (form_error('telefono_cliente') != '') {
                      ...
                      <input type="text" class="form-control" name="telefono_cliente" id="telefono_cliente" value="<?php if (validation_errors('telefono_cliente') != '') {
                ...
                <tr>
                  ...
                  <td >
                    <div class="form-group <?php if (form_error('email_cliente') != '') {
                      ...
                      <input type="email" class="form-control" name="email_cliente" id="email_cliente" value="<?php if (validation_errors() != '') {
                ...
                <tr>
                  ...
                  <td >
                    <div class="form-group <?php if (form_error('cli_ciudad') != '') {
                      ...
                      <input type="text" class="form-control" name="cli_ciudad" id="cli_ciudad" value="<?php if (validation_errors() != '') {
                ...
                <td>
                      ...
                      <td>
                          <div class="form-group <?php if (form_error('fac_fecha_emision') != '') {
                            ...
                            <input type="date" class="form-control" name="fac_fecha_emision" id="fac_fecha_emision" value="<?php if (validation_errors() != '') {
                            ...
                            <input type="hidden" class="form-control" name="emp_id" id="emp_id" value="<?php if (validation_errors() != '') {
                              echo set_value('emp_id');
                            } else {
                              echo $factura->emp_id;
                            } ?>">
                            <input type="hidden" class="form-control" name="emi_id" id="emi_id" value="<?php if (validation_errors() != '') {
                              echo set_value('emi_id');
                            } else {
                              echo $factura->emi_id;
                            } ?>">
                            <input type="hidden" class="form-control" name="cja_id" id="cja_id" value="<?php if (validation_errors() != '') {
                              echo set_value('cja_id');
                            } else {
                              echo $factura->cja_id;
                            } ?>">
                            <input type="hidden" class="form-control" name="ped_id" id="ped_id" value="<?php if (validation_errors() != '') {
